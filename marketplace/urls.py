...
from .views import listings, detail, create_listing, dashboard, analyze_listing_images, upload_listing_photo
...
urlpatterns = [
    ...
    path('publier/upload-photo/', upload_listing_photo, name='upload_listing_photo'),
